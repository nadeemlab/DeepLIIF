// This class is taken from "ij.gui.HTMLDialog" and modified slightly.
...
public class MutableHTMLDialog extends JDialog implements ActionListener, KeyListener, HyperlinkListener, WindowListener {
	private boolean escapePressed;
	private JEditorPane editorPane;
	private boolean modal = true;

	public MutableHTMLDialog(String title, String message) {
		super(ij.IJ.getInstance(), title, true);
		init(message);
	}

	public MutableHTMLDialog(Dialog parent, String title, String message) {
		super(parent, title, true);
		init(message);
	}

	public MutableHTMLDialog(String title, String message, boolean modal) {
